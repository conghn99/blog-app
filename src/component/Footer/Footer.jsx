...
function Footer() {
  return (
    <>
        <footer className="footer"><span>Cong Do &copy; 2023</span>
            <span className="social-icons"><a href="https://github.com/conghn99" aria-label="Github">
                    <svg
                    ...
                    </svg></a><a href="#" aria-label="CodePen"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    </svg></a><a href="#" aria-label="Stackoverflow"><svg
                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentcolor"
                        strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path
                    ...
                    </svg></a><a href="https://leetcode.com/akushitenma1/" aria-label="HackerRank"><svg
                        xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 35"
                        fill="currentcolor" strokeWidth="0" stroke="currentcolor">
                        <g>
                            <path
